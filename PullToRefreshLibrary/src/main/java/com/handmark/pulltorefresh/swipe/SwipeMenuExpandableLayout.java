 ...
 * 
 */
public class SwipeMenuExpandableLayout extends FrameLayout {
	...
	private SwipeMenuExpandableView mMenuView;
	private int mDownX;
	...
	public SwipeMenuExpandableLayout(View contentView, SwipeMenuExpandableView menuView) {
	...
	private SwipeMenuExpandableLayout(Context context, AttributeSet attrs) {
		super(context, attrs);
	}

	private SwipeMenuExpandableLayout(Context context) {
		super(context);
	}
	...
	public void setChildPosition(int position) {
		...
		mMenuView.setChildPosition(position);
	}
	...
	public SwipeMenuExpandableView getMenuView() {
		return mMenuView;
	}
