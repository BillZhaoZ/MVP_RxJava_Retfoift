...
import com.handmark.pulltorefresh.interfaces.ILoadingLayout;
import com.handmark.pulltorefresh.interfaces.IPullToRefresh;
...
import com.handmark.pulltorefresh.internal.ScaleRotateLoadingLayout;
...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements IPullToRefresh<T> {
    ...
    // 2014-12-29 Added by ZhangMao
    protected LoadingLayout createLoadingLayout(Context context, Mode mode, TypedArray attrs, AnimationStyle animStyle) {
        LoadingLayout layout = AnimationStyle.createLoadingLayout(context, mode, getPullToRefreshScrollDirection(), attrs, animStyle);
        layout.setVisibility(View.INVISIBLE);
        return layout;
    }
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        // We need to update the layout_refresh_header_view/footer when our size changes
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        // We need to create new layouts now
        // 2014-12-29 Modified by ZhangMao
        // mHeaderLayout = createLoadingLayout(context, Mode.PULL_FROM_START, a);
        // mFooterLayout = createLoadingLayout(context, Mode.PULL_FROM_END, a);
        // 绕开mLoadingAnimationStyle自动判断机制，直接手动初始化mHeaderLayout和mFooterLayout，实现头部和脚步应用不同的动画
        mHeaderLayout = createLoadingLayout(context, Mode.PULL_FROM_START, a, AnimationStyle.SCALE_ROTATE);
        mFooterLayout = createLoadingLayout(context, Mode.PULL_FROM_END, a, AnimationStyle.ROTATE);
    ...
    public static enum AnimationStyle {
        ...
        // 2014-12-29 Added by ZhangMao
        public static LoadingLayout createLoadingLayout(Context context, Mode mode, Orientation scrollDirection, TypedArray attrs, AnimationStyle animStyle) {
            switch (animStyle) {
                case ROTATE:
                default:
                    return new RotateLoadingLayout(context, mode, scrollDirection, attrs);
